...
> = {
  ...
  meta: {
    modelProps:
      'user' | 'repository' | 'review' | 'userUsage' | 'session' | 'account' | 'verification';
...
export type UserUsageScalarFieldEnum =
  (typeof UserUsageScalarFieldEnum)[keyof typeof UserUsageScalarFieldEnum];
